...
def show_main_menu(profile):
    ...
    menu_items = [
        ...
        ("8", "Beli Paket Dengan (Option Code)"),
        ("9", "Beli Paket Dengan (Family Code)"),
        ("10", "Beli Semua Paket (Looping)"),
    ...
    while True:
        ...
        if active_user is not None:
            ...
            if choice.lower() == "t":
                ...
                family_code = cyber_input("Family code ('99' Cancel)")
                if family_code == "99":
                    continue
